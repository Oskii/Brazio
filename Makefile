...
pkgdatadir = $(datadir)/brazio
pkgincludedir = $(includedir)/brazio
pkglibdir = $(libdir)/brazio
pkglibexecdir = $(libexecdir)/brazio
...
ACLOCAL = ${SHELL} /home/a/Brazio/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/a/Brazio/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/a/Brazio/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/a/Brazio/build-aux/missing automake-1.15
AWK = mawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = brazio-cli
BITCOIN_DAEMON_NAME = braziod
BITCOIN_GUI_NAME = brazio-qt
BITCOIN_TX_NAME = brazio-tx
...
COPYRIGHT_HOLDERS_FINAL = The Brazio developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Brazio
COPYRIGHT_YEAR = 2017
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /home/a/Brazio/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
PACKAGE_NAME = Brazio
PACKAGE_STRING = Brazio 0.1.1
PACKAGE_TARNAME = brazio
PACKAGE_URL = https://brazio.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/a/Brazio
abs_srcdir = /home/a/Brazio
abs_top_builddir = /home/a/Brazio
abs_top_srcdir = /home/a/Brazio
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/a/Brazio/build-aux/install-sh
...
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/brazio.icns
...
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/brazio.ico \
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/brazio.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Brazio-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/Resources/brazio.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/Brazio-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Brazio-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Brazio-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
